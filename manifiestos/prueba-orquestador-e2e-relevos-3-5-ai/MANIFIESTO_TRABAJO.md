...
Debe iniciarse el relevo periódico del CONSTRUCTOR al alcanzarse cada múltiplo absoluto de tres intervenciones computables del CONSTRUCTOR conforme a `metodo-manifiestos-ai`.
...
Debe relevarse periódicamente al AUDITOR cada cinco intervenciones auditoras computables conforme a `metodo-manifiestos-ai`.
...
3. los relevos periódicos del CONSTRUCTOR se procesan sobre la grilla absoluta de tres;
4. los relevos periódicos del AUDITOR se procesan sobre la grilla absoluta de cinco;
